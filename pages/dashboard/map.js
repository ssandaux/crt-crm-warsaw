        ...
        action={
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-[12px] font-medium border border-gray-200 bg-white text-gray-600 hover:border-gray-300 hover:text-gray-800 transition-all"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-gray-900 text-white text-[12px] sm:text-[13px] font-semibold hover:bg-gray-800 transition-all"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
